      ...
      <div className="mx-auto max-w-3xl">
        <Tabs defaultValue="world" className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger value="world" className="flex flex-col items-center py-4">
              <Clock className="h-6 w-6 mb-1" />
              <span>World</span>
            </TabsTrigger>
            <TabsTrigger value="alarm" className="flex flex-col items-center py-4">
              <AlarmClock className="h-6 w-6 mb-1" />
              <span>Alarm</span>
            </TabsTrigger>
            <TabsTrigger value="stopwatch" className="flex flex-col items-center py-4">
              <StopwatchIcon className="h-6 w-6 mb-1" />
              <span>Stopwatch</span>
            </TabsTrigger>
            <TabsTrigger value="timer" className="flex flex-col items-center py-4">
